...
require("neo-tree").setup({
  ...
  default_component_configs = {
    ...
    icon = {
      folder_closed = icons.ui.ArrowClosed,
      folder_open = icons.ui.ArrowOpen,
      folder_empty = "ﰊ",
    ...
    git_status = {
      symbols = {
        ...
        modified = icons.git.Diff, -- or "", but this is redundant info if you use git_status_colors on the name
        ...
        -- Status type
        -- untracked = icons.git.Untracked, -- this can only be used in the git_status source
        ignored  = "",
        unstaged = "",
        staged   = "",
        conflict = "",
