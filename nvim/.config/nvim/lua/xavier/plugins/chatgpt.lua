return {
	...
	-- Keybinds
	vim.keymap.set("n", "<leader>cp", ":ChatGPT<cr>"),
	vim.keymap.set("n", "<leader>ce", ":ChatGPTEditWithInstructions<cr>", { noremap = true }),
	vim.keymap.set("i", "<c-a>", "<ESC>:ChatGPTRunCustomCodeAction<cr>", { noremap = true }),
