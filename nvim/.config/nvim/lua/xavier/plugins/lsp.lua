return {{
    ...
    {"jose-elias-alvarez/null-ls.nvim"}, {"jose-elias-alvarez/typescript.nvim"}, {"MunifTanjim/prettier.nvim"},
    {"onsails/lspkind.nvim"}, -- Autocompletion
    {"hrsh7th/nvim-cmp"}, -- Required
    {"hrsh7th/cmp-nvim-lsp"}, -- Required
    {"L3MON4D3/LuaSnip"}, -- Required
    {"rafamadriz/friendly-snippets"}, {"honza/vim-snippets"}, {"hrsh7th/cmp-buffer"}, {"hrsh7th/cmp-path"},
    {"hrsh7th/cmp-cmdline"}, {"hrsh7th/cmp-nvim-lua"}, {"saadparwaiz1/cmp_luasnip"},
    {"lukas-reineke/cmp-under-comparator"}, {"FelipeLema/cmp-async-path"}, {
    ...
    config = function()
        ...
        cmp.setup({
            ...
            sorting = {
                comparators = {cmp.config.compare.offset, cmp.config.compare.exact, cmp.config.compare.score,
                               cmp.config.compare.recently_used, cmp.config.compare.locality, cmp.config.compare.kind,
        ...
        null_ls.setup({
            sources = {null_ls.builtins.formatting.prettierd.with({
                timeout = 10000
            }), null_ls.builtins.diagnostics.eslint_d.with({
                diagnostics_format = "[eslint] #{m}\n(#{c})"
            }), null_ls.builtins.code_actions.refactoring, null_ls.builtins.formatting.black,
                       null_ls.builtins.formatting.isort, require("typescript.extensions.null-ls.code-actions"),
