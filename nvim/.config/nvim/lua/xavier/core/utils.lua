-- Commands
vim.cmd("command! CheckLspServerCapabilities :lua =require('xavier.core.utils').custom_server_capabilities()")
vim.cmd("command! DownloadSpellFiles :lua =require('xavier.core.utils').download_spell_files()")
vim.cmd("command! GetActiveLSPClients :lua =require('xavier.core.utils').get_active_lsp_clients()")
