...
vim.keymap.set("n", "<M-c>", function()
    vim.cmd(
        [[ silent !tmux new-window /Users/xavier/.claude/local/claude --dangerously-skip-permissions]])
...
-- fzf-lua git files (theprimeagen style)
vim.keymap.set("n", "<leader>pf", function()
  require("fzf-lua").git_files()
end, { desc = "Find git files" })

-- Alternative <C-p> mapping (overrides oil/floaterm in normal mode)
